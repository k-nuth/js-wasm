...
describe('Transaction', () => {
    it('Should return false if the transaction is not valid', () => {
        const tx = new Transaction();
        expect(tx.valid).toBe(false);
    });

    it('Should parse successfully a transaction', () => {
        ...
        expect(tx.serializedSize(true)).toEqual(275);
    ...
    // createTransaction() *********************
    // transaction.ts:71 toAddress: qr0087jg6392rlz2jwnsttwpjmwrx7n0pv748afn5p
    // transaction.ts:72 amount: 0.00121684
    // transaction.ts:73 utxos: [
    //      {"txid":"d2d6fddf950616a7146b529789252224e9fd58b63bb596941b35a64de6fccae6","vout":1,"amount":0.00809311,"address":"bitcoincash:qz2kc5e0hn0jn4kcak99zvyl9zzvq9cpcceuq5ns70","lastChecked":1738101885646},
    //      {"txid":"cf15921fe231a5db2789456b8c44eed08e8276a99a34b43e957372afe2dead0d","vout":0,"amount":0.00245264,"address":"bitcoincash:qz2kc5e0hn0jn4kcak99zvyl9zzvq9cpcceuq5ns70","lastChecked":1738101885646}]
    // transaction.ts:74 changeAddress
